...
DESCRIBE_PROMPT = (
    ...
    "长度要求：根据信息密度控制在 200~1000 字之间——简单图约 200~400 字，复杂图约 600~1000 字，最多不超过 1000 字；不要为凑字数而编造或重复。"
)
...
CHAT_IMAGE_PROMPT = (
    ...
    "长度按图片复杂度灵活控制在 200~1000 字之间：简单图约 200~400 字，复杂图约 600~1000 字，最多不超过 1000 字。"
)

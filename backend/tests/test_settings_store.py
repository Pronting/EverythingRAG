...
from app.core.settings_store import AppSettings, ChatModelConfig, EmbedModelConfig, SettingsStore
...
def test_load_empty_uses_env_defaults(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    """无 config.json 时：chat 回退 env，embed 默认 local bge-m3，system_prompt 用内置。"""
